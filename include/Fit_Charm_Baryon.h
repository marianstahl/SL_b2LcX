...
double* Fit_Charm(RooDataHist *datapass, RooDataHist *datafail, configuration* myconfig){
  ...
  if(myconfig->get_particle().Contains("Lc")){MXcstart = 2287; MXclo = 2282; MXchi = 2292;}
  // sigma's
  ...
  double Xcsig1start = 15000; double Xcsiglo = 500; double Xcsighi = 1500000;
...
void Fit_Charm(RooDataHist *data, configuration* myconfig){
  ...
  double MXcstart = 2470; double MXclo = 2460; double MXchi = 2478;
  if(myconfig->get_particle().Contains("Omegac")){MXcstart = 2695; MXclo = 2685; MXchi = 2705;}
  if(myconfig->get_particle().Contains("Lc")){MXcstart = 2286; MXclo = 2280; MXchi = 2295;}
  // sigma's
  ...
  //normalizations
  double sfracstart = 0.4; double sfraclo = 0.3; double sfrachi = 0.75;
  double Xcsig1start = 15000; double Xcsiglo = 0.0; double Xcsighi = 2500000;
  double bkgstart = 100000; double bkglo = 100; double bkghi = 1e+7;
  ...
  if(myconfig->get_particle().Contains("Lc"))temp.Form("N_{#Lambda^{+}_{c}} = %.0f #pm %.0f", Nsig,signal_yield->getError());
